...
a dias, b horas, c minutos e d segundos. Seja cuidadoso com o formato! Espaços a mais, vírgulas faltando ou outras
...
converter = int(input("Por favor, entre com o número de segundos que deseja converter: "))

dias = converter // 86400
horas = (converter % 86400) // 3600
minutos = ((converter % 86400) % 3600) // 60
segundos = ((converter % 86400) % 3600) % 60
